...
function getTotalRows($conn, $tableName, $joinQuery = null, $condition = null, $params = []) {
...
$condition = "p.email = ? AND e.enrollment_status = 'rejected'";  

$params = ['s', $parentEmail];  

$totalfounddata = getTotalRows($conn, 'enrollment e', $joinQuery, $condition, $params);
                    ...
                    <div class="box ">
                        <div class="box-header pt-0">
                            <div class="" style="display: flex;flex-wrap:wrap;justify-content: space-between;width: 100%;">
                                <h4 class="card-title mb-0 fs-22">Rejected&nbsp;Enrollments<br><span style="font-size: 15px;color: #EF5741" id="totalfound">0 Found</span></h4>
...
$query = "
    ...
    WHERE 
        e.enrollment_status = 'rejected' AND p.email = '$parentEmail'
    ORDER BY 
