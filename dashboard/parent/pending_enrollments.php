...
$condition = "p.email = ? AND e.enrollment_status = 'pending'";  
                    ...
                    <div class="box ">
                        <div class="box-header pt-0">
                            <div class="" style="display: flex;flex-wrap:wrap;justify-content: space-between;width: 100%;">
                                <h4 class="card-title mb-0 fs-22">Pending&nbsp;Enrollments<br><span style="font-size: 15px;color: #E4A40F"><?php echo $totalfounddata; ?> Found</span></h4>
