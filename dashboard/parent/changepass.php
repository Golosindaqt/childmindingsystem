...
$query = "
    SELECT user.*
    FROM user
    WHERE user.user_id = $parentUserId
";
    ...
    <div class="row">
        <div class="col-12">
            <div class="box">
                <div class="box-body">
                    <!-- Hidden teacher ID -->
                    <input name="parent_user_id" value="<?php echo $parentUserId; ?>" hidden>
                        ...
                        <div class="col-md-6 col-sm-12 mb-24">
                            <div class="form-group">
                                ...
                                <input class="form-control" 
                                       name="username"
                                       type="text" 
                                       value="<?php echo htmlspecialchars($parentData['username']); ?>"
...
eyeIcon.addEventListener('click', () => {
    ...
    $(document).ready(function() {
        $('#saveChangesBtn').click(function(e) {
            ...
            var formData = {
                parent_user_id: $("input[name='parent_user_id']").val(),
